...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-005-0006-baker-s-dozen-periodic-multidimensiona-99bfb70d",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-005-0006-2abf4829729c",
        "url": "https://www.unsolvedmath.com/problems/AMR-005-0006"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For a smooth strictly convex hypersurface $M\\subset\\mathbb{R}^{2n}$, find lower bounds for the number of $p$-periodic outer-billiard orbits for values of $p$ other than $3$.",
      "version": 1
    },
    "title": "Baker's Dozen — Periodic multidimensional outer-billiard trajectories",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "d89be5f9161be3bea553630cfcaac110e49c835409f9f4a7941b02eafc70e8da"
}
```
